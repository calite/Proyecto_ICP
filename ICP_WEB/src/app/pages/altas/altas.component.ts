...
export class AltasComponent {
  ...
  constructor(
    ...
    this.formularioAltaReparacion = this.formBuilder.group({
      ...
      recogida_provincia: ['', Validators.required],
      recogida_codigo_postal: ['', Validators.required],
      recogida_persona_contacto: ['', Validators.required],
      recogida_telefono: ['', Validators.required],
      envio_calle: ['', Validators.required],
      envio_numero: ['', Validators.required],
      envio_poblacion: ['', Validators.required],
      envio_provincia: ['', Validators.required],
      envio_codigo_postal: ['', Validators.required],
      envio_persona_contacto: ['', Validators.required],
      envio_telefono: ['', Validators.required]
    });
